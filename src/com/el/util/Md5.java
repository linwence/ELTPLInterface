...
//			byte[] messageDigest = md.digest(input.getBytes());
	...
	private static String writeShortEscape(char c) throws IOException {
		...
		return sb.toString();
		/*
		 * gen.writeRaw('\\'); gen.writeRaw(c);
		 */
	}

	public static void main(String[] args) {

		// Md5.md5s("{\"body\":{\"data\":{\"source_order_id\":\"14347012309352\"},\"errno\":20101,\"error\":\"\u8bf7\u6c42\u683c\u5f0f\u4e0d\u6b63\u786e\"},\"cmd\":\"resp.order.create\",\"source\":\"65400\",\"ticket\":\"909c3b92-8cdd-af2c-c887-5b660233e2b2\",\"timestamp\":\"1432119870\",\"version\":\"2.0\"}");
		// String unicodeStr = Md5
		// .string2Unicode("{\"body\":{\"name\":\"哈哈\",\"shop_id\":\"1\"},\"cmd\":\"dish.category.get\",\"secret\":\"5a5cdda47e233d9c\",\"source\":\"65478\",\"ticket\":\"8C7D975C-9E9B-F8AB-0D8A-D1B5E3ECF786\",\"timestamp\":1445997186,\"version\":2}");
		String unicodeStr = Md5
		...
		String md5 = Md5.getMD5(unicodeStr);
